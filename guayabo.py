...
pygame.init()
idioma=int(input("Seleccione un idioma/Select a language:\n\n1.English\n2. Español\n"))
modo=int(input("Seleccione un modo/select a mode:\n\n1.Easy\n2. Normal\n\n3. Hard\n"))
time.sleep(5)
if modo==1:
    import pygame, random, time
    pygame.init()
...
if modo==2:
    ...
    if idioma==1:
        ...
        Luna_info=pygame.image.load("info1.png").convert()
    if idioma==2:
        tardigrado_info=pygame.image.load("carac.png").convert()
        Luna_info=pygame.image.load("Luna.png").convert()
    ...
    t=0
    for i in range(30):
        enemy_x.append(random.randrange(1200,1250))
        enemy_y.append(random.randrange(450,550))
        enemy2_x.append(random.randrange(0,50))
        enemy2_y.append(random.randrange(450,550))
    #print(enemy_x,"\n\n",enemy_y)
    while running:
        for event in pygame.event.get():
